...
REQUIRED_CHANNELS = ["@freefirelikehack"]
GROUP_JOIN_LINK = "https://t.me/freefirelikehack"
OWNER_ID = 8636730338
OWNER_USERNAME = "@FFZEN"
...
def call_api(region, uid):
    url = f"https://free-fire-like-bot-faba.onrender.com/like?uid={uid}&server_name={region}"
    try:
